...
API_KEY = { "popular": "4d277dbda0a14f54bf521a86d98e5725",
            "article": "4d277dbda0a14f54bf521a86d98e5725"}
...
def article_overview(kind, period):
    ...
    for article in data:
        ...
        for media in article['media']:
            urls += [m['url'] for m in media['media-metadata'] if m['format'] == 'Standard Thumbnail']
